...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
    ...
    <div class="bg-white p-6 rounded-lg shadow-md flex items-center space-x-4">
        ...
        <div>
            ...
            <p class="text-2xl font-bold text-gray-800">172</p>
        </div>
    </div>
    ...
    <div class="space-y-4">
        <div class="flex items-center">
            <div class="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center mr-4">
                <span class="font-bold text-green-600">BS</span>
            </div>
            <div>
                <p class="text-gray-800"><strong>Arsa Budiantoro</strong> mengumpulkan laporan untuk <strong>Modul 2</strong></p>
                <p class="text-sm text-gray-500">10 menit lalu</p>
            </div>
        </div>
        <div class="flex items-center">
            <div class="w-10 h-10 rounded-full bg-green-100 flex items-center justify-center mr-4">
                <span class="font-bold text-green-600">CL</span>
            </div>
            <div>
                <p class="text-gray-800"><strong>Apin Alfan</strong> mengumpulkan laporan untuk <strong>Modul 2</strong></p>
